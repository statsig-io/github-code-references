...
hoistedDependencies:
  ...
  /@octokit/plugin-retry/4.1.6_@octokit+core@4.2.4:
    '@octokit/plugin-retry': private
  /@octokit/plugin-throttling/5.2.3_@octokit+core@4.2.4:
  ...
  /jest-circus/29.5.0:
    jest-circus: private
  /jest-cli/29.5.0_@types+node@20.3.1:
    jest-cli: private
  /jest-config/29.5.0_@types+node@20.3.1:
    jest-config: private
  /jest-diff/29.5.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Thu, 22 Jun 2023 16:49:00 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
