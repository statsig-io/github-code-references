...
async function getProjectData() {
    ...
    if (GithubUtils_1.default.getGithubEventName() == "workflow_dispatch" || GithubUtils_1.default.isGithubEventSchedule()) {
        ...
        // Ignore any local changes, there shouldn't be any so far
